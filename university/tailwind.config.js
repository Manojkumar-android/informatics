    ...
    extend: {
      ...
      colors: {
        primary: {
          ...
          "opacity-80": "rgba(245, 130, 32,  0.8)",
          "opacity-60": "rgba(245, 130, 32,   0.6)",
          "opacity-30": "rgba(245, 130, 32,  0.3)",
          "opacity-20": "rgba(245, 130, 32,  0.2)",
          "opacity-10": "rgba(245, 130, 32,  0.1)",
        },
        secondary: {
